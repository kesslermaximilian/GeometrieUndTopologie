%! TEX root = ../../master.tex
\lecture[Zusammenhang, Wegzusammenhang. Bilder (weg-) zusammenhängender Räume. Lemma von Urysohn.]{Di 11 Mai 2021}{Zusammenhang}

\section{Zusammenhang, Wegzusammenhang}

\begin{definition}[Zusammenhang]\label{def:zusammenhang}
    Ein topologischer Raum heißt \vocab[Topologischer Raum!zusammenhängend]{zusammen"-hängend}, wenn er sich \underline{nicht} in zwei nichtleere, disjunkte, offene Teilmengen zerlegen lässt. 
\end{definition}
...
\begin{figure}[ht]
    \centering
    \incfig{urysohn-funktion-ueber-dyadische-zahlen}
...
\begin{proof}
    ...
    \begin{IEEEeqnarray*}{rCl}
        x\in f^{-1}([0,a)) & \iff & f(x) < a \leq  1 \\
                           ...
                           &\stackrel{\mathbb{Q} \text{ ist dicht}}{\iff} & \exists r < a, r\in \mathbb{Q} \colon x\in V_r \\
    ...
    \begin{IEEEeqnarray*}{rCl}
        ...
        \end{cases} \\
                           & \iff  & \exists r'>a, r'\in \mathbb{Q}, x\not\in V_{r'} \\
                           & \stackrel{\overline{V_r} \subset V_{r'}}{\iff}  & \exists r\in \mathbb{Q}, a<r < r', x\not\in \overline{V_r} \\
