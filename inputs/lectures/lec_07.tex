%! TEX root = ../../master.tex
\lecture[Universelle Eigenschaft unendlicher Produkte. Satz von Tychonoff. Abschluss, Dichtheit. Einbettungen. Kompaktifizierung. Vollständige Regularität. Universelle Eigenschaft der Stone-Čech-Kompaktifizierung. Fortsetzung stetiger Funktionen.]{Di 04 Mai 2021}{Kompaktifizierung}
...
\begin{example}
    \begin{enumerate}[a)]
        ...
        \item Betrachte $\left \{0,2\right\} $ mit der diskreten Topologie. Dann ist
            ...
            .\] 
            kompakt nach dem \nameref{thm:tychonoff}. Dann ist $\prod_{\mathbb{N}} \left \{0,2\right\} $ aber nicht diskret, weil wir sonst die offene Überdeckung
            \[
