%! TEX root = ../../master.tex
\lecture[Eigenschaften kompakter Hausdorffräume. Gerade mit zwei Ursprüngen. Heine-Borel. Homöomorphismen.]{Do 22 Apr 2021}{Mehr zu Kompaktheit, Hausdorffräumen und Homöomorphismen}
\begin{dexample}[mündlich vor der Vorlesung]
    ...
    .\] 
    Punkturbilder sind endlich, also abgeschlossen. Aber der Raum $[0,1] / \sim $ ist nicht hausdorffsch, denn wir können die Punkte $0,1$ nicht trennen.
\end{dexample}
...
\begin{proof}
    ...
    Eine Teilmenge $W\subset X$ heißt \vocab[Menge!saturiert]{saturiert}, falls $W = q^{-1}(q(W))$ (insbesondere sind alle Urbilder saturiert, und $\iff  \forall x\in X \setminus W : g(x) \in Z \setminus g(W)$).
    \end{ddefinition}
\begin{remark}
