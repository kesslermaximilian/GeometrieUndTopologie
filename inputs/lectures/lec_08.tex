%! TEX root = ../../master.tex
\lecture[Disjunkte Vereinigungen. Koprodukte. Disjunkte Vereinigungen über einem Basisraum. Wedge-Produkte. Rekonstruktion eines Raumes als Disjunkte Vereinigung über dem Schnitt zweier Teilräume.]{Do 06 Mai 2021}{Disjunkte Vereinigungen (Koprodukte)}
...
\begin{example}
    ...
    \begin{minipage}{\textwidth}
        ...
        \captionof{figure}{Disjunkte Vereinigung von $D^2$ und $D^2$ über $S^1$}
    \end{minipage}
\end{example}
\begin{warning}
...
\begin{proof}
    ...
    \begin{minipage}{\textwidth}
        ...
        \captionof{figure}{Beweisskizze zu \autoref{lm:injektive-einbettung-ergibt-injetive-projektion-auf-koprodukt-über-basis}}
    \end{minipage}
\end{proof}
