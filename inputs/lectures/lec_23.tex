...
\centering
\includegraphics[scale=0.35]{figures/handdrawn/graph.png}
\captionof{figure}{Einige Graphen als $CW$-Komplexe}
\end{minipage}
...
Für eine Skizze siehe \autoref{fig:cw-komplex-s^n}.
...
\begin{figure}
    \centering
    \includegraphics[scale=0.25]{figures/handdrawn/sphaere-cw-komplex.png}
    \caption{CW-Komplex von $S^n$}
    \label{fig:cw-komplex-s^n}
\end{figure}
...
\begin{example}
    ...
    \begin{minipage}{\textwidth}
    \centering
    \includegraphics[scale=0.25]{figures/handdrawn/graph-mit-baum.png}
    \captionof{figure}{Ein Graph mit markiertem Teilbaum (grün markiert)}
    \end{minipage}
...
\item Ist $Z'$ der folgende Graph:
    ...
    \begin{minipage}{\textwidth}
    \centering
    \includegraphics[scale=0.25]{figures/handdrawn/graph-mit-3-kreisen.png}
    \end{minipage}
